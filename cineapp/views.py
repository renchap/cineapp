	...
	for cur_user in users:
		...
		if marked_movie != None:
			...
			if marked_movie.homework_who != None and marked_movie.mark == None:
				mark_users.append({ "user": cur_user, "mark": "homework_in_progress", "seen_where": None, "seen_when": None, "comment": None, "homework_who": marked_movie.homework_who_user, "mark_comments": marked_movie.comments })
			else:
				mark_users.append({ "user": cur_user, "mark": marked_movie.mark, "seen_where": seen_where_text, "seen_when": marked_movie.seen_when.strftime("%d/%m/%Y") ,"comment": marked_movie.comment, "homework_who": marked_movie.homework_who_user, "mark_comments": marked_movie.comments })
		else:
